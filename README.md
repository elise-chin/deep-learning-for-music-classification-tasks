...
## Problem Statement
Music Information Retrieval (MIR) is a large area of research dedicated to extract useful information from music and one of the challenging task for MIR systems is to classify music by genre and mood automatically. An automatic tagging algorithm could be useful for music recommander systems or playlists generators for instance.
